...
var recent = document.getElementsByClassName('recent-time');
    ...
    for (var i = 0; i <= Timetable.length - 1; i++) {
        timetables.innerHTML += "<div class='bus-number' id='" + i + "'><a href='timeTableResults.html' class='busroute'> <p class='bus-route-num'>" + Timetable[i].Route + "</p> <div  class='bus-locations'><p>" + Timetable[i].From + "-" + Timetable[i].To + "</p><div class='recent-time'></div></div></a> </div>";
